...
\begin{itemize}
    ...
    \begin{itemize}
        \item In an automated patch management process, detect \rightarrow assess \rightarrow acquire \rightarrow test \rightarrow deploy \rightarrow maintain is the process that is followed
    \end{itemize}
\end{itemize}
